...
An interactive Power BI dashboard analyzing India’s e-commerce sales data, including profit, sales amount, quantity, and average order value. Features charts by state, customer, payment mode, and sub-category with slicers for Quarter (Q1-Q4) &amp; Indian States for dynamic insights. 
...
# Tools Used
Power BI – Pivot Charts, Slicers, Data Processing

How to Use
1️. Download the Power BI file from this repository
2️. Open in Power BI (Desktop recommended)
